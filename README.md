...
|---|---|
| ماژول دامنه | **۲۵** |
| تست Backend | **۶۱۷ تست / ۶۹۴۲ ادعا** — همه سبز |
| تست اپ | **۴۴۵ تست + ۱۱ تصویر Golden** — همه سبز |
| مسیر API | **۱۸۹** |

**Backend** — Core، Ledger، Budget، Reports، Banking، Investment، Assets،
Buildings، Business، Payroll، Travel، Family، Recurring، Documents، Search، AI،
Sync، Billing، Alerts، Audit، I18n، Security، DataOps، MarketData، Capture.

**اپ** — پنج صفحهٔ روزمره در نوار پایین (داشبورد، تراکنش‌ها، گزارش‌ها،
حساب‌ها، تنظیمات)، و ۱۵ مقصد در صفحهٔ «بیشتر»: بانک، سرمایه‌گذاری، دارایی،
سفر، ساختمان، کسب‌وکار، اسناد، جستجو، هشدارها، بودجه، تراکنش‌های تکرارشونده،
خانواده، اجراهای حقوق، کارمندان و قواعد مالیاتی.

ورود با رمز و کد دومرحله‌ای، و از تنظیمات: اعضا و دعوت‌ها، گزارش فعالیت،
گزارش امنیتی، اشتراک، خروجی داده و حذف حساب.

**هر ۶۸ صفحهٔ اپ از داخل خود اپ قابل دسترسی است** — تستی این را می‌سنجد،
چون صفحه‌ای که ساخته شده ولی هیچ‌جا باز نمی‌شود از دید کاربر وجود ندارد و
تست‌های خودش تا ابد سبز می‌مانند.
