...
return [
    ...
    */
    ...
    // The queue split from docs/01 §5. The point of separating them is that a
    // slow OCR batch must not delay a due-date alert, and a nightly report run
    // must not delay either.
    'defaults' => [
        'realtime' => [
            'connection' => 'redis',
            'queue' => ['realtime'],
        ...
        'ocr' => [
            ...
            'memory' => 512,
            'tries' => 3,
            // OCR on a large photo is genuinely slow; a short timeout here just
            // retries the same expensive work.
            'timeout' => 300,
            'nice' => 0,
        ],
        'ai' => [
